...
\subtitle{Unsupervised discovery of mid-level discriminative patches} % Subtitle of technical report (use small letters only)

\repcity{Graz}            % City where the report was created

\repdate{\today}          % Date of creation

\keywords{Report, AKCV KU 2012, visual representation, unsupervised discovery} % keywords that appear below the abstract
...
As stated before, these patches to represent the image should be found in an unsupervised manner. Therefore, Singh et al.
